...
public class FinishedClientFragment extends Fragment implements SecondNavigationItem, GroceryListListener
    ...
    public String getName(Context context) {
        return context.getString(R.string.finishedCaps);
    }
